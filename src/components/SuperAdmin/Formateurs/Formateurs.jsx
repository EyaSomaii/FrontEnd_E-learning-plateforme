...
import Liste_Formateurs from "../../Containers/Liste_Formateurs";
...
export default function Formateurs() {
  ...
  const handleTextSearch = async (e) => {
    ...
    axios.get("http://localhost:3001/User/Formateurs").then((res) => {
          ...
          <div className="list">
            ...
            <ChakraProvider>
              ...
              >
                <Badge colorScheme="purple" fontSize="1em" borderRadius="full">
                  <p style={{ textAlign: "center" }}>Liste des formateurs</p>
                </Badge>
              </Stack>
            </ChakraProvider>
            ...
            >
              <input
                ...
                type="search"
                placeholder="Recherche formateur"
                name="searchTerm"
              ...
              <div style={{ height: "calc(100% - 64px)", overflowY: "scroll" }}>
                <TableContainer component={Paper}>
                  <Table aria-label="collapsible table">
                    <TableHead>
                      <TableRow>
                        <TableCell>{user.length} Formateurs </TableCell>
                        <TableCell align="left">Contact</TableCell>
                        <TableCell align="left">Inscriptions</TableCell>
                        <TableCell align="left">Curriculum vitae</TableCell>
